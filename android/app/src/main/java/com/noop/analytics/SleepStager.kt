...
object SleepStager {
     ...
     *  Mirrors Swift `bandStateWakeVetoEnabled`. (H9) */
     ...
     *  bare "asleep". Mirrors Swift `bandVetoRecoverStage`. (H9) */
    ...
    // ── H9 @73 band-state WAKE-veto (recover strap-disputed false wakes) ──────────
    //
     ...
     * Mirrors Swift `applyBandStateWakeVeto`. (H9)
     */
