...
object AnalyticsEngine {
    ...
    fun analyzeDay(
        ...
        val nightlySkinTempC = wornNightlySkinTempC(matched, hr, skinTemp, skinTempFamily, skinTempAnchorRaw,
            chargeIntervals, wornToleranceSec = skinTempWornToleranceSec)
    ...
    internal fun wornNightlySkinTempC(
        ...
        skinTempFunnel(sessions, hr, skinTemp, family, anchorRaw, chargeIntervals, minSamples, wornToleranceSec).mean
